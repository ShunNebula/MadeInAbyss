...
@export var noise_scale: float = 0.04      # Масштаб шума, влияет на размер холмов
@export var height_multiplier: float = 3.0 # Максивальная высота холмов
...
@export var hole_radius: float = 10.0
...
func _ready():
	print("Layer 02 Generator is ready.")
	#generate_surface()
